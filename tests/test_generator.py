...
@pytest.mark.parametrize(
    "input_transactions, input_code_transactions, return_filtered_transactions",
    [
        (
            [
                {
...
def test_filter_by_currency(input_transactions, input_code_transactions, return_filtered_transactions):
    assert list(filter_by_currency(input_transactions, input_code_transactions)) == return_filtered_transactions
